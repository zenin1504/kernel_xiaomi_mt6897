 ...
 *==================================================
 */
static int wifi_cooling_get_max_state(struct thermal_cooling_device *cdev,
				      unsigned long *state)
{
...
static int wifi_cooling_get_cur_state(struct thermal_cooling_device *cdev,
				      unsigned long *state)
{
	struct wifi_cooling_device *wifi_cdev = cdev->devdata;
...
static int wifi_cooling_set_cur_state(struct thermal_cooling_device *cdev,
				      unsigned long state)
{
	struct wifi_cooling_device *wifi_cdev = cdev->devdata;
...
static int
cooling_state_to_wifi_level_limit(struct wifi_cooling_device *wifi_cdev)
{
	int ret = -1;
	struct device *dev = wifi_cdev->dev;
