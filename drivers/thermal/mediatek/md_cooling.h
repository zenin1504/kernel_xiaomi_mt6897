...
enum tmc_cooler_lv_ctrl { TMC_COOLER_LV_ENABLE = 0, TMC_COOLER_LV_DISABLE };
...
#define TMC_CA_CTRL_CA_ON_MSG (TMC_CTRL_CMD_CA_CTRL | TMC_CA_ON << 8)
#define TMC_CA_CTRL_CA_OFF_MSG (TMC_CTRL_CMD_CA_CTRL | TMC_CA_OFF << 8)
#define TMC_PA_CTRL_PA_ALL_ON_MSG (TMC_CTRL_CMD_PA_CTRL | TMC_PA_ALL_ON << 8)
#define TMC_PA_CTRL_PA_OFF_1PA_MSG (TMC_CTRL_CMD_PA_CTRL | TMC_PA_OFF_1PA << 8)
...
#define duty_ctrl_to_tmc_msg(active, suspend, ims)                         \
	((ims) ? ((active << 16) | (suspend << 24) | TMC_IMS_ENABLE_MSG) : \
...
#define reduce_tx_pwr_to_tmc_msg(id, pwr)                                      \
	(((id) == TMC_OVERHEATED_NR) ?                                         \
		 (TMC_CTRL_CMD_TX_POWER |                                      \
		  (TMC_TX_PWR_REDUCE_NR_MAX_TX_EVENT << 16) | ((pwr) << 24)) : \
		 (TMC_CTRL_CMD_TX_POWER |                                      \
...
extern struct md_cooling_device *get_md_cdev(enum md_cooling_type type,
					     unsigned int pa_id);
